...
namespace zCode.zCore
{
    ...
    public static class ColorUtil
    {
        ...
        {
            int r = zMath.Clamp((int)vector.X, 255);
            int g = zMath.Clamp((int)vector.Y, 255);
            int b = zMath.Clamp((int)vector.Z, 255);
        ...
        public static Vec3d LCHtoLAB(Vec3d color)
        {
            double l = color.X;
            double c = color.Y;
            double h = zMath.ToRadians(color.Z);
        ...
        public static Vec3d LABtoLCH(Vec3d color)
        {
            ...
            h = (h > 0.0) ? zMath.ToDegrees(h) : zMath.ToDegrees(360.0 - Math.Abs(h));
