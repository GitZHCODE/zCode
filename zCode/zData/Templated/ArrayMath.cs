...
namespace zCode.zData
{
	...
	public static partial class ArrayMath
	{
        ...
        /// 
        /// </summary>
        public static bool ApproxEquals(double[] v0, double[] v1, double tolerance = zMath.ZeroTolerance)
        {
        ...
        /// 
        /// </summary>
        public static bool ApproxEquals(double[] v0, double[] v1, int count, double tolerance = zMath.ZeroTolerance)
        {
            for (int i = 0; i < count; i++)
        ...
        /// 
        /// </summary>
        public static bool ApproxEquals(float[] v0, float[] v1, float tolerance = zMath.ZeroTolerancef)
        {
            return ApproxEquals(v0, v1, v0.Length, tolerance);
        }
        ...
        /// 
        /// </summary>
        public static bool ApproxEquals(float[] v0, float[] v1, int count, float tolerance = zMath.ZeroTolerancef)
        {
            for (int i = 0; i < count; i++)
                if (Math.Abs(v1[i] - v0[i]) >= tolerance) return false;
        ...
        /// 
        /// </summary>
        public static bool ApproxEquals(Vec2d[] v0, Vec2d[] v1, double tolerance = zMath.ZeroTolerance)
        {
            return ApproxEquals(v0, v1, v0.Length, tolerance);
        }
        ...
        /// 
        /// </summary>
        public static bool ApproxEquals(Vec2d[] v0, Vec2d[] v1, int count, double tolerance = zMath.ZeroTolerance)
        {
            for (int i = 0; i < count; i++)
        ...
        /// 
        /// </summary>
        public static bool ApproxEquals(Vec3d[] v0, Vec3d[] v1, double tolerance = zMath.ZeroTolerance)
        {
            return ApproxEquals(v0, v1, v0.Length, tolerance);
        }
        ...
        /// 
        /// </summary>
        public static bool ApproxEquals(Vec3d[] v0, Vec3d[] v1, int count, double tolerance = zMath.ZeroTolerance)
        {
            for (int i = 0; i < count; i++)
                if (!v0[i].ApproxEquals(v1[i], tolerance)) return false;
