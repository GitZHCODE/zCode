...
namespace zCode.zMesh
{
        ...
        where TF : HeMesh<TV, TE, TF>.Face
    {
        ...
        /// <returns></returns>
        public TM CreateFromPolygons<T>(IEnumerable<T> polygons, Action<TV, Vec3d> setPosition, double tolerance = zMath.ZeroTolerance)
        ...
        /// </summary>
        /// <returns></returns>
        public TM CreateTetrahedron(Action<TV, Vec3d> setPosition, Action<TV, Vec3d> setNormal)
        {
        ...
        */
        ...
        /// <param name="setPosition"></param>
        /// <returns></returns>
        public TM CreateBevelledDual<UV, UE, UF>(HeMesh<UV, UE, UF> mesh, Func<UV, Vec3d> getPosition, Func<UV, double> getScale, Func<UF, Vec3d> getCenter, Action<TV, Vec3d> setPosition)
            where UV : HeMesh<UV, UE, UF>.Vertex
            where UE : HeMesh<UV, UE, UF>.Halfedge
            where UF : HeMesh<UV, UE, UF>.Face
        {
