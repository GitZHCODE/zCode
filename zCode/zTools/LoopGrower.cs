...
namespace zCode.zTools
{
    ...
    public static class LoopGrower
    {
        ...
        public class Solver
        {
            ...
            private IField3d<Vec3d> _directionField;
            ...
            /// 
            /// </summary>
            public IField3d<Vec3d> DirectionField
            {
        ...
        public class Settings
        {
            ...
            public double Alignment
            {
                ...
                set { _alignment = zMath.Saturate(value); }
            }
            ...
            {
                get { return _damping; }
                set { _damping = zMath.Saturate(value); }
            }
